...
![[attachments 1/Paste-image-20250622.png]]
### h
...
> `$`表示变量
> ![[attachments 1/Paste-image-20250622-1.png]]
### p
...
![](./HTML/Paste-image-20250622-1.png)
...
无序列表常用于制作菜单 或 新闻列表。
![[attachments/Paste-image-20250623-1.png]]
### 定义列表
...
例如，查看h1元素中是否可以包含p元素
不可以
![[attachments/Paste-image-20250623-2.png]]
总结：
